            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-end gap-2 pt-4 border-t">
                ...
                <Button
                  ...
                  disabled={selectedDays.length === 0 || !priceForDays || !apartmentIdForDays || bulkSaving}
                >
                  {bulkSaving ? (
                    <>
          ...
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription>
                  {filteredAndSortedPrices.length} precios en la página {currentPage + 1}
                </CardDescription>
              </div>
            </div>
          </CardHeader>
                            ...
                            <TableCell>
                              <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                  ...
                                  <DropdownMenuItem onClick={() => handleEditClick(price)}>
        ...
        <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleEditSave} disabled={saving || !editPrice || !editApartmentId || !editDate}>
                {saving ? (
                  <>
                    <RefreshCw className="h-4 w-4 mr-2 animate-spin" />
                    Guardando...
