                  ...
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="cursor-pointer hover:bg-muted/50" onClick={() => handleSort("lastName")}>
                        Apellido {sortField === "lastName" && (sortDirection === "asc" ? "↑" : "↓")}
                      </TableHead>
                      <TableHead className="cursor-pointer hover:bg-muted/50" onClick={() => handleSort("phone")}>
                        Teléfono {sortField === "phone" && (sortDirection === "asc" ? "↑" : "↓")}
                      </TableHead>
        ...
        <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                ¿Estás seguro de que quieres eliminar al cliente {clientToDelete?.name} {clientToDelete?.lastName}?
                {clientToDelete && (
