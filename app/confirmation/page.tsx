        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              Gracias por tu reserva. Hemos enviado un correo electrónico de
              confirmación
            </p>
          </div>
                  ...
                  <Accordion type="single" collapsible className="w-full">
                      ...
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>
                            ...
                            detalladas para el check-in 24 horas antes de tu
                            llegada.
                          </li>
                          <li>
                            Prepara tu identificación (DNI o pasaporte) para el
                            registro.
                          </li>
                          <li>
                            Si necesitas transporte desde el aeropuerto,
                            contáctanos con al menos 48 horas de antelación.
                          </li>
                        </ul>
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                      ...
                      <AccordionContent>
                        <ul className="list-disc pl-5 space-y-2">
                          <li>
                            Nuestro equipo de recepción está disponible 24/7
                            para cualquier consulta.
                          </li>
                          <li>
                            Wifi gratuito disponible en todo el establecimiento
                            (contraseña en la carpeta de información).
                          </li>
                          <li>
                            Servicio de limpieza diario incluido en tu reserva.
                          </li>
                        </ul>
                      </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-3">
                      ...
                      <AccordionContent>
                        <p>
                          ...
                          llegada. Después de este período, se cobrará el
